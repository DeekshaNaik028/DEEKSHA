      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
          ...
          <div className="flex justify-center scroll-reveal">
            <div className="relative group">
              {/* Glowing background */}
              <div className="absolute inset-0 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl blur-2xl opacity-20 group-hover:opacity-40 transition-opacity animate-pulse"></div>
              
              {/* Decorative border */}
              <div className="absolute -inset-1 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl opacity-50 group-hover:opacity-100 transition-opacity"></div>
              ...
              <div className="relative">
                ...
                {/* Floating badge */}
                <div className="absolute -bottom-4 -right-4 bg-slate-800 border-2 border-emerald-500 rounded-xl px-4 py-2 shadow-lg animate-float">
                  <p className="text-emerald-400 font-bold text-sm font-mono">Available for Work</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6 scroll-reveal">
            ...
            <div className="mt-6 grid grid-cols-1 gap-4">
              <div className="flex items-center gap-3 p-3 bg-slate-800/50 rounded-lg border border-slate-700 hover:border-emerald-500/50 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-emerald-400 font-mono">Mangalore, IN</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {aboutData.stats.map((stat, idx) => (
            <div 
              key={idx} 
              className="group bg-slate-800/50 backdrop-blur-sm p-8 rounded-2xl text-center hover:-translate-y-3 transition-all border border-slate-700 hover:border-emerald-500 scroll-reveal card-shine relative overflow-hidden"
